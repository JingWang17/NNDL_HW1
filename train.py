...
for num in num_hidden_list:
    for lr in lr_list:
        for l2 in l2_list:
            print(' ')
            print('num:{},lr:{},l2:{}'.format(num, lr, l2))

            train_iter = DataLoader(X_train, y_train, batch_size)
            test_iter = DataLoader(X_test, y_test, batch_size)
            network = mlp(num_input, num, num_output, lr, l2)
            ...
            network.cpu()
            np.save('/Users/wangjing/Desktop/hw1/param_' + str(num) + '_' + str(lr) + '_' + str(
            ...
            plt.legend()
            plt.savefig(
                '/Users/wangjing/Desktop/hw1/loss_' + str(num) + '_' + str(lr) + '_' + str(
                    l2) + '.png')
            ...
            plt.savefig(
                '/Users/wangjing/Desktop/hw1/accuracy_' + str(num) + '_' + str(lr) + '_' + str(
                    l2) + '.png')
